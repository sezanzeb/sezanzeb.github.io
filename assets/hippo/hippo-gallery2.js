...
/**
 * prevents scrolling on the page, but only if hippo-lightbox-bg is loaded
 *
 * @param e		the event object that the browser creates
 */
...
/**
 * enables a previously prevented scrolling on the page
 *
 * @param e		the event object that the browser creates
 */
